...
export const metadata = createMetadata({
  title: "About",
  description: "Learn about DevToolsKit — free, browser-based developer utilities built for speed and privacy.",
  path: "/about",
});
...
export default function AboutPage() {
  return (
    <div className="container mx-auto max-w-3xl px-4 py-12">
      <h1 className="text-3xl font-bold mb-6">About DevToolsKit</h1>
      <div className="prose prose-zinc dark:prose-invert max-w-none space-y-4 text-muted-foreground">
        <p>
          DevToolsKit is a collection of free developer utilities designed to help you work faster.
        ...
        <p>
          ...
          or convert timestamps, DevToolsKit provides fast, reliable tools without any sign-up or API dependency.
        </p>
        <h2 className="text-xl font-semibold text-foreground mt-8">Why DevToolsKit?</h2>
