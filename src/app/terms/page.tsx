...
export const metadata = createMetadata({
  ...
  description: "DevToolkit terms of service for using our free developer tools.",
  path: "/terms",
});
  ...
  return (
    <div className="container mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="space-y-4 text-muted-foreground">
        ...
        <p>
          By using DevToolkit, you agree to these terms. DevToolkit provides free developer
        ...
        <p>
          You may use DevToolkit for personal and commercial purposes. You are responsible
        ...
        <p>
          While we strive for accuracy, DevToolkit tools are provided without guarantee.
        ...
        <p>
          DevToolkit and its operators shall not be liable for any damages arising from
