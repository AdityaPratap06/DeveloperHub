...
export interface ToolAdditional {
  title: string;
  description: string;
}
...
export const TOOL_SEO_CONTENT: Record<string, ToolSeoContent> = {
  "json-formatter": {
    title: "JSON Formatter Online – Beautify, Pretty Print & Minify JSON",
    metaDescription:
  ...
  "json-validator": {
    title: "JSON Validator Online – Validate & Fix JSON Syntax Errors",
    metaDescription:
  ...
  "html-formatter": {
    title: "HTML Formatter Online - Beautify & Format HTML Code Free",
    metaDescription:
